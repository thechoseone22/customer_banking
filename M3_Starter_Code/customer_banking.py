...
def main():
    ...
    savings_interest = float(input("What is your APR for the savings account? "))
    ...
    print("The updated balance is: $", format(updated_savings_balance, ',.2f'))
    ...
    print("The updated balance is: $", format(updated_cd_balance, ',.2f'))
    print("the interest earned is: $", format(cd_interest_earned, ',.2f'),'%')
